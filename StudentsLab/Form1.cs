...
namespace StudentsLab
{
    public partial class Form1 : Form
    {
        ...
        string path = ""; // путь дл€ сохранени€ текущего файла, если он уже был сохранен в определЄнном месте.
        ...
        private void сохранить‘айлToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            writer.Close();
            MessageBox.Show("‘айл сохранЄн", "—туденты", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            добавить—тудентаToolStripMenuItem.Enabled = false;
        ...
        private void сохранитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (path == "")
            {
                сохранить‘айлToolStripMenuItem_Click_1(sender, e);
                return;
            }
